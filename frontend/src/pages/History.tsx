...
import { fetchAllCases, deleteCase, type CaseHistory } from '../api';
import { Activity, Clock, Users, ChevronDown, ChevronUp, Trash2, Terminal } from 'lucide-react';
                  ...
                  {xaiEnabled && xaiLogs.length > 0 && (
                     <div style={{ background: '#0f172a', border: '1px solid #1e293b', padding: '16px', borderRadius: '12px', color: '#38bdf8', marginBottom: '24px' }}>
                        ...
                        <div style={{ display: 'flex', flexDirection: 'column', gap: '16px' }}>
                           {xaiLogs.map((log: any, idx: number) => (
